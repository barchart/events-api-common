...
module.exports = (() => {
	...
	const portfolioEditScreenInvoked = new EventType('PORTFOLIO-SCREEN-INVOKED-EDIT', 'Edit Screen Invoked', ProductType.WATCHLIST, ['userId', 'watchlistId', 'positionId', 'symbol']);
