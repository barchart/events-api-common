...
module.exports = (() => {
	...
	const watchlistCustomViewCreated = new EventType('CUSTOM-VIEW-CREATED', 'Custom View Created', ProductType.WATCHLIST, ['userId', 'viewName']);
	const watchlistCustomViewDeleted = new EventType('CUSTOM-VIEW-DELETED', 'Custom View Deleted', ProductType.WATCHLIST, ['userId', 'viewName']);

	const watchlistViewTypeChanged = new EventType('VIEW-TYPE-CHANGED', 'View Type Changed', ProductType.WATCHLIST, ['userId', 'watchlistId', 'viewType']);
	const watchlistViewChanged = new EventType('VIEW-CHANGED', 'View Changed', ProductType.WATCHLIST, ['userId', 'watchlistId', 'viewName']);

	const watchlistDataModeChanged = new EventType('DATA-MODE-CHANGED', 'Data mode changed', ProductType.WATCHLIST, ['userId', 'watchlistId', 'dataMode']);
	...
	const watchlistPortfolioAddScreenInvoked = new EventType('PORTFOLIO-ADD-SCREEN-INVOKED', 'Portfolio Add Screen Invoked', ProductType.WATCHLIST, ['userId', 'watchlistId', 'tgamSymbol']);
	const watchlistSymbolNotesScreenInvoked = new EventType('SYMBOL-NOTES-SCREEN-INVOKED', 'Symbol Notes Screen Accessed', ProductType.WATCHLIST, ['userId', 'watchlistId', 'tgamSymbol']);
