...
module.exports = (() => {
	...
	class EventType extends Enum {
		...
		static get ENTITLEMENTS_REGISTER_MODAL_CLOSED() {
			return entitlementsRegisterModalClosed;
		}

		static get ENTITLEMENTS_REGISTER_MODAL_GET_STARTED_CLICKED() {
			return entitlementsRegisterModalGetStartedClicked;
		}

		static get ENTITLEMENTS_REGISTER_MODAL_LOGIN_CLICKED() {
			return entitlementsRegisterModalLoginClicked;
		}

		static get ENTITLEMENTS_REGISTER_MODAL_SUBSCRIBE_CLICKED() {
			return entitlementsRegisterModalSubscribeClicked;
		}

		static get ENTITLEMENTS_SUBSCRIBER_MODAL_CLOSED() {
			return entitlementsSubscriberModalClosed;
		}

		static get ENTITLEMENTS_SUBSCRIBER_MODAL_SUBSCRIBE_CLICKED() {
			return entitlementsSubscriberModalSubscribeClicked;
		}

		static get ENTITLEMENTS_SUBSCRIBER_MODAL_MAYBE_LATER_CLICKED() {
			return entitlementsSubscriberModalMaybeLaterClicked;
		}
	...
	const entitlementsRegisterModalClosed = new EventType('ENTITLEMENTS_REGISTER_MODAL_CLOSED', 'Register modal closed', ProductType.ENTITLEMENTS, ['product', 'userId']);
	const entitlementsRegisterModalGetStartedClicked = new EventType('ENTITLEMENTS_REGISTER_MODAL_GET_STARTED_CLICKED', 'Register Modal \'Get Started For Free\' Clicked', ProductType.ENTITLEMENTS, ['product', 'userId']);
	const entitlementsRegisterModalLoginClicked = new EventType('ENTITLEMENTS_REGISTER_MODAL_LOGIN_CLICKED', 'Register Modal \'Login\' Clicked', ProductType.ENTITLEMENTS, ['product', 'userId']);
	const entitlementsRegisterModalSubscribeClicked = new EventType('ENTITLEMENTS_REGISTER_MODAL_SUBSCRIBE_CLICKED', 'Register Modal \'Subscribe\' Clicked', ProductType.ENTITLEMENTS, ['product', 'userId']);
	const entitlementsSubscriberModalClosed = new EventType('ENTITLEMENTS_SUBSCRIBER_MODAL_CLOSED', 'Subscriber Modal Closed', ProductType.ENTITLEMENTS, ['product', 'userId']);
	const entitlementsSubscriberModalSubscribeClicked = new EventType('ENTITLEMENTS_SUBSCRIBER_MODAL_SUBSCRIBE_CLICKED', 'Subscriber Modal \'Subscribe\' Clicked', ProductType.ENTITLEMENTS, ['product', 'userId']);
	const entitlementsSubscriberModalMaybeLaterClicked = new EventType('ENTITLEMENTS_SUBSCRIBER_MODAL_MAYBE_LATER_CLICKED', 'Subscriber Modal \'Maybe Later\' Clicked', ProductType.ENTITLEMENTS, ['product', 'userId']);
